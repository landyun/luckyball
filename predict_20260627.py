# -*- coding: utf-8 -*-
"""预测 2026-06-27 第2026073期 双色球 (v3.2)"""
import sys
...
for f in freq_feats:
    ...
    freq_total += fi
    print(f"  {f}: {fi:.4f}")
print(f"  → 4频率特征合计: {freq_total:.4f} (v3.1 is_prev_red=0.4568)")

# ============ 3. Backtest ============
print("\n【滚动回测 (start=120, 最近94期)】")
...
# ============ 4. Predict for 2026-06-27 19:58 ============
print("\n" + "=" * 60)
print("预测: 2026-06-27 19:58 (第2026073期)")
print("=" * 60)

target = datetime(2026, 6, 27)
...
for i in range(len(results)):
    ...
    print(f"  组{i+1} vs 组1: 重叠 {overlap_with_1}/6 红球, 蓝球 {results[i]['pred_blue']}")
