# -*- coding: utf-8 -*-
"""Quick prediction for 2026-06-30 (v3.2)"""
import sys, os
sys.path.insert(0, '.')
...
# ======= Predict for 2026-06-30 =======
print()
print('='*60)
print('=== PREDICTION for 2026-06-30 21:08 (第2026074期) ===')
print('='*60)
...
print(f'最近蓝球: {blue_series[-1]} (第{df["qi"].iloc[-1]}期)')
print('⚠️ 纯娱乐预测，请理性购彩！')
